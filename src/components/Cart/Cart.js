...
const Cart = ({cart, handleUpdateCartQty, handleRemoveFromCart, handleEmptyCart}) => {
  ...
  const EmptyCart = () => (
    <Typography variant="subtitle1">No tienes items en tu carrito de compras
    ...
    <>
      ...
      <div className={classes.cardDetails}>
        ...
        <div>
          ...
          <Button component={Link} to="/checkout" className={classes.checkoutButton} size="large" type="button" variant="contained" color="primary">Confirmar pedido</Button>
        </div>
      </div>
    </>
  );
